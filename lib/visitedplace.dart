...
class visitedPlaces extends StatelessWidget {
  ...
  visitedPlaces({required this.user});

  @override
  Widget build(BuildContext context) {
    final places = manage.getvisitedPlaces(user!.Email);

    return Scaffold(
      appBar: AppBar(
        title: Text("الأماكن التي تمت زيارتها"),
        leading: IconButton(
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text("لا توجد أماكن تمت زيارتها بعد", style: TextStyle(fontSize: 22, color: Colors.grey)),
                      ],
                    ),
                  )
                : ListView.builder(
